...
/**
 * <pre> 
 * 네이버 실시간 검색 테스트 프로모션 Controller
 * </pre>
 * 
 * @ClassName		: PRBNaverTestPromotionController.java
 * @Description		: 네이버 실시간 검색 테스트 프로모션 Controller
 * @author 이너스커뮤니티
 * @since 2019.07.15
 * @version 1.0
 * @see
...
@Controller
@RequestMapping("/pr-center/promotion")
public class PRBNaverTestPromotionController extends EmfController {
	...
	private String strStartDate = "2019-07-18 14:00:00";
	private String strEndDate = "2019-07-18 15:00:00";
	private String strNaverCheck = "Y";
	private String strFromurlCheck = "Y";
	private int iDivision = 1;
	...
	public String selectNaverTestPromotion(EmfMap emfMap, ModelMap modelMap, HttpServletRequest request) throws Exception
	{
		String strView = "";
		...
		try
		{
			...
			if(bStartCheck == true && bEndCheck == true) {
				...
				if(this.strNaverCheck.equals("Y") && this.strFromurlCheck.equals("Y")){
					if(strReferer != null && !strReferer.isEmpty() && (strReferer.indexOf("search.naver.com") > -1 || strReferer.indexOf("adcr.naver.com") > -1) && fromurl != null && (fromurl.equals("PC_BSmain") || fromurl.equals("PC_BS01") || fromurl.equals("PC_BS02") || fromurl.equals("PC_BS03") || fromurl.equals("MO_BSmain") || fromurl.equals("MO_BS01") || fromurl.equals("MO_BS02") || fromurl.equals("MO_BS03"))) {
					} else{
						strView = "notNaver";
					}
				}
				if(this.strNaverCheck.equals("N") && this.strFromurlCheck.equals("Y")){
					if(fromurl != null && (fromurl.equals("PC_BSmain") || fromurl.equals("PC_BS01") || fromurl.equals("PC_BS02") || fromurl.equals("PC_BS03") || fromurl.equals("MO_BSmain") || fromurl.equals("MO_BS01") || fromurl.equals("MO_BS02") || fromurl.equals("MO_BS03"))) {
					} else{
						strView = "notNaver";
					}
				}
		...
		return "front/pr/prb/PRBNaverPromotionView.front";
	}
	...
	public ModelAndView insertNaverTestPromotion(EmfMap emfMap, HttpServletRequest request) throws Exception
	{
		...
		try
		{
			...
			if(!strView.equals("prev") && !strView.equals("next") && !strView.equals("notNaver"))
			{
				...
				emfMap.put("NTEVT_DIVISION", this.iDivision);
