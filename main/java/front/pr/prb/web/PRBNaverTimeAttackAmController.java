...
@Controller
@RequestMapping("/pr-center/timeattack/am")
public class PRBNaverTimeAttackAmController extends EmfController {
	...
	private String strStartDate = "2019-08-29 11:00:00";
	private String strEndDate = "2019-08-29 13:00:00";
	private String strNaverCheck = "Y";
	private String strFromurlCheck = "Y";
	private int iDivision = 2;
	...
	public String selectNaverTimeAttackPromotion(EmfMap emfMap, ModelMap modelMap, HttpServletRequest request) throws Exception
	{
		...
		return "front/pr/prb/PRBNaverTimeAttackAmView.front";
	}
