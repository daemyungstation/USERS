...
/**
 * <pre> 
 * 청약철회 안내를 위한 Controller
 * </pre>
 * 
 * @ClassName		: MLECnclRefndController.java
 * @Description		: 청약철회을 위한 Controller
 * @author 허진영
 * @since 2016.03.14
 * @version 1.0
 * @see
 ...
 */ 
@Controller
@RequestMapping("/my-lifeway/service-guide/subscription-withdrawal")
public class MLESbscpWtdrController extends EmfController {
	...
	public String selectJoinPrdctList(EmfMap emfMap, ModelMap modelMap) throws Exception
	{
		...
		return "front/ml/mle/MLESbscpWtdrGuideView.front";
	}
}
