 ...
 * </pre>
 * 
 * @ClassName		: MLDChngRqstOutDAO.java
 ...
 * </pre>
 */
@Repository("mLDChngRqstOutDAO")
public class MLDChngRqstOutDAO extends EmfAbstractOutDAO {	
	...
	{
		return (EmfMap) selectByPk("MLDChngRqstOutDAO.selectJoinPrdct", emfMap);
	}
}
