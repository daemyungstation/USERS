...
/**
 * FileNotSizeException : 비즈니스 서비스 구현체에서 발생시키는 Biz Exception 
 * 
 ...
 * </pre>
 */
public class FileNotSizeException extends BaseException {

	private static final long serialVersionUID = 1L;

	/**
	 * FileNotSizeException 생성자
	 */
	public FileNotSizeException() {
	 ...
	 */
	public FileNotSizeException(String defaultMessage) {
	 ...
	 */
	public FileNotSizeException(String defaultMessage, Exception wrappedException) {
	 ...
	 * @param wrappedException 발생한 Exception 내포함.
	 */
	public FileNotSizeException(String defaultMessage, Object[] messageParameters, Exception wrappedException) {
	 ...
	 */
	public FileNotSizeException(MessageSource messageSource, String messageKey) {
	 ...
	 * @param wrappedException 발생한 Exception 내포함.
	 */
	public FileNotSizeException(MessageSource messageSource, String messageKey, Exception wrappedException) {
		this(messageSource, messageKey, null, null, Locale.getDefault(), wrappedException);
	}

	public FileNotSizeException(MessageSource messageSource, String messageKey, Locale locale, Exception wrappedException) {
		this(messageSource, messageKey, null, null, locale, wrappedException);
	}

	public FileNotSizeException(MessageSource messageSource, String messageKey, Object[] messageParameters, Locale locale,
	        Exception wrappedException) {
		this(messageSource, messageKey, messageParameters, null, locale, wrappedException);
	}

	public FileNotSizeException(MessageSource messageSource, String messageKey, Object[] messageParameters,
	        Exception wrappedException) {
