...
<%	
	...
	String returnUrl = "https://"+request.getServerName()+"/outsourcing/ipinAuthSMART2.do";		
	//String returnUrl = "http://"+request.getServerName()+":8080/outsourcing/ipinAuthSMART2.do";
