...
<%
	...
	String RTN_URL = "https://"+request.getServerName()+"/outsourcing/cardAuthSMART2.do";		// 본인인증 완료 후 리턴될 URL (도메인 포함 full path)
	//String RTN_URL = "http://"+request.getServerName()+":8080/outsourcing/cardAuthSMART2.do";		// 본인인증 완료 후 리턴될 URL (도메인 포함 full path)
