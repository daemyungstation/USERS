<%@ page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%><%@include file="/WEB-INF/jsp/include/el.jspf" %>
									...
									<ul class="boradType4 type2">
										...
										<c:forEach var="list" items="${rtnMap.list}" varStatus="status">
											<li>
												...
												<div class="info">
													<p class="txt1">
														<a href="javascript:selectPrsnCnslDtl('${list.prsnCnslSeq}');">${egov:tldCutString(list.titl, '...', '35')}</a>
													</p>
													<p class="txt2">
						...
						//<![CDATA[
							...
							//상세 가져오기
							function selectPrsnCnslDtl(prsnCnslSeq)
							{
								var f = document.frm;
								
								f.action = "./view.do";
								f.prsnCnslSeq.value = prsnCnslSeq;
								f.submit();
							}
