						...
						//<![CDATA[
							...
							jQuery(document).ready(function(){
								...
								jQuery("#btnSearch").on("click", function(e){
									...
									selectMbspCardInf(jQuery(srchObj).val());
								});
								
								<c:if test="${empty rtnMap.accntNo}">
									jQuery("#accntNo option:eq(1)").prop("selected", true);
								</c:if>
								
								jQuery("#btnSearch").trigger("click");
							});
							
							function selectMbspCardInf(accntNo)
							{
