<%@ page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%><%@include file="/WEB-INF/jsp/include/el.jspf" %>
					...
					<div data-controller="CommonController FindController">
						<div class="idpwDiv">
							<p class="txt1">아이디를 모르시나요?</p>
							<p class="txt2">아이디 찾기 방법을 선택해 주세요. </p>
							<div class="srchBox">
								<div class="accredit1">
									<p class="txt3">휴대폰 인증</p>
									<p class="txt4">본인명의의 휴대폰으로 인증절차를 거쳐 개인정보 유출을 방지하는<br>개인정보보호 수단입니다.</p>
									<!-- <a href="/auth/getPhoneAuthInf.do?rtnUrl=/member/findid/complete.do" class="whtBt">휴대폰 인증</a> -->
							...
							<p class="goPw">
								비밀번호를 찾으시나요?
								<a href="/member/findpass/index.do">비밀번호 찾기</a>
							</p>
						</div>
						
						<form name="form1" action="/auth/phoneAuth.do" method="post">
							<input type="hidden" name="rqst_caus_cd" value="03" />
							<!-- input type="hidden" name="rMsg" value="/member/findid/complete.do" / -->
							<input type="hidden" name="rMsg" value="/member/findid/complete_sso.do" />
						</form>
