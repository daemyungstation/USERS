					...
					<div data-controller="CommonController OnlinePrdctAgreeController">
						...
						<div class="termDiv mt60">
							...
							<div class="termBox">
								...
								<p class="txt mt10">▷ 제공 및 보존기간 : 제공목적 달성 시 또는 회원탈퇴 시까지(보존기간 : 탈퇴 후 5년)</p>
								<div class="txt mt10">
									<table summary="">
										<caption></caption>
										<colgroup>
						...
						<div class="termDiv mt60">
							<p class="tit">6. 개인정보 처리업무 위탁동의 (필수)</p>
							...
							<div class="termBox">
								...
								<p class="txt mt10">▷ 제공 및 이용기간 : 제공목적 달성 시 또는 위탁계약 종료 시점까지</p>
								<div class="txt mt10">
									<table summary="">
										<caption></caption>
										<colgroup>
