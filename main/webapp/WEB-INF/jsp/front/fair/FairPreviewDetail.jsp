...
<html lang="ko">
	...
	<style>
		...
		.input .form .input_rule .agree_text { position:absolute; width:340px; height:340px; overflow-y:auto; top:30px; left:-125px; background-color:#ffffff; padding:20px 25px; box-sizing:border-box; border:1px solid #e4e4e4; z-index:1; display:none; }
		...
		.topMove a { position:fixed; bottom:0; text-decoration:none; }
			...
			jQuery("textarea[name='INPUT']").each(function(){
				...
				for(var i = 0; i < jsonInput.INPUT.length; i++) {
					...
					//결합혜택
						...
						html += '<a href="#" onclick="javascript:jQuery(this).benefit_list();"><div class="wrap col3" id="benefit_product">선택하기</div></a><div id="benefitList"></div></td>';
						html += '</tr>';
						html += '<tr>';
						html += '<td class="spacetr" colspan="5"></td>';
						html += '</tr>';
						...
						html += '<td class="title" onclick="javascript:jQuery(this).benefit_list();">결합혜택</td>';
						html += '<td class="write">';
						html += '<a href="#" onclick="javascript:jQuery(this).benefit_list();"><div class="wrap col1" id="benefit_product">선택하기</div></a><div id="benefitList"></div></td>';
						html += '</tr>';
						html += '<tr>';
						html += '<td class="spacetr" colspan="5"></td>';
						html += '</tr>';
	...
	<div class="topMove"><a href="#"><img class="logo" src="/common/images/fairimage/btn_top.png"></a></div>
