<%@ page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%><%@include file="/WEB-INF/jsp/include/el.jspf" %>
						...
						<div class="paging mt30">
							<ui:pagination paginationInfo="${rtnMap.paginationInfo}" type="image" jsFunction="getFaqPageList" />
						</div>
						...
						<div class="listSrch mt30">
							...
							<a href="javascript:getFaqPageList();" class="btn333">검색</a>
							<a href="javascript:getFaqPageList('all');" class="btnGry">전체보기</a>
						</div>
