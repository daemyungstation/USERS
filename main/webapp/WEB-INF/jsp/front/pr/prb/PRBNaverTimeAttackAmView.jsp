...
.quiz_container .quiz_inner .quiz_item .quiz_item_table { width:55% !important; margin:00px auto 0 auto; }
.quiz_container .quiz_inner .quiz_item .quiz_item_table .quiz_item_checkbox { width:7%; position:relative; cursor:pointer; }
.quiz_container .quiz_inner .quiz_item .quiz_item_table .quiz_item_checkbox .quiz_checkbox_on { position:absolute; top:50%; left:50%; transform:translate(-50%, -70%); display:none; }
.quiz_container .quiz_inner .quiz_item .quiz_item_table .quiz_item_txt { width:93%; text-align:left; font-size:23px; color:#131550; padding:7px 0 7px 20px; font-weight: bold;  word-break:keep-all; cursor:pointer; }
...
@media (max-width: 640px) {
	.quiz_container .quiz_inner .quiz_question .quiz_question_table .quiz_question_txt { font-size:23px; }
	.quiz_container .quiz_inner .quiz_item .quiz_item_table .quiz_item_txt { font-size:22px; }
...
@media (max-width: 500px) {
	.quiz_container .quiz_inner .quiz_question .quiz_question_table .quiz_question_txt { font-size:23px; }
	.quiz_container .quiz_inner .quiz_item .quiz_item_table .quiz_item_txt { font-size:22px; }
	.quiz_container .quiz_inner .quiz_item .quiz_item_table .quiz_item_checkbox { width: 10%; }
	.quiz_container .quiz_inner .quiz_item .quiz_item_table .quiz_item_txt { width: 90%; }
}
...
<c:choose>
	<c:when test="${strView eq 'prev' || strView eq 'next'}">
		...
		function nextgo1(){
			jQuery.post("./click.ajax", { NTEVTPV_DIVISION: "99981"},
				function(r) 
				{
		...
		function nextgo2(){
			jQuery.post("./click.ajax", { NTEVTPV_DIVISION: "99982"},
				function(r) 
				{
	...
	<c:otherwise>
		...
		function answer(num){
			...
			if(obj.val() == "N") {
				obj.val("Y");
				$(".quiz_item_table").each(function(){
					$(this).find("tr").eq(num-1).find(".quiz_checkbox_on").show();	
				});
			}else {
				obj.val("N");
				$(".quiz_item_table").each(function(){
					$(this).find("tr").eq(num-1).find(".quiz_checkbox_on").hide();	
				});
			}
		}
		...
		function show_modal_info() {
			...
			$('.greyBackModal').show();
			if(f.answer1.value == "N" && f.answer2.value == "N" && f.answer3.value == "N" && f.answer4.value == "Y"){
				$('.modal_info').show();
			}else {
				$('.modal_hint').show();
			}
...
<c:choose>
	<c:when test="${strView ne 'notNaver'}">
		<div class="pc">
			<div><img src="/common/images/promotion/am_pc_01.jpg" style="width:100%;"/></div>
				...
				<div class="quiz_inner">
						...
						<table class="quiz_question_table">
							<tr>
								...
								<td class="quiz_question_txt">
									다음 중 <span>대명아임레디 상품 가입</span> 시 누릴 수 있는 <span>가입혜택이 아닌 것은</span>?
								</td>
							</tr>
						</table>
					</div>
					<div class="quiz_item">
						<table class="quiz_item_table">
							<tr>
								<td class="quiz_item_checkbox" onclick="javascript:answer('1');">
									<img src="/common/images/promotion/am_pc_checkbox.png" style="width:100%;"/>
									<img src="/common/images/promotion/am_pc_checkbox_on.png" style="width:100%;" class="quiz_checkbox_on"/>
								</td>
								<td class="quiz_item_txt" onclick="javascript:answer('1');">
									오션월드 할인혜택
								</td>
							</tr>
							<tr>
								<td class="quiz_item_checkbox" onclick="javascript:answer('2');">
									<img src="/common/images/promotion/am_pc_checkbox.png" style="width:100%;"/>
									<img src="/common/images/promotion/am_pc_checkbox_on.png" style="width:100%;" class="quiz_checkbox_on"/>
								</td>
								<td class="quiz_item_txt" onclick="javascript:answer('2');">
									스키월드 할인혜택
								</td>
							</tr>
							<tr>
								<td class="quiz_item_checkbox" onclick="javascript:answer('3');">
									<img src="/common/images/promotion/am_pc_checkbox.png" style="width:100%;"/>
									<img src="/common/images/promotion/am_pc_checkbox_on.png" style="width:100%;" class="quiz_checkbox_on"/>
								</td>
								<td class="quiz_item_txt" onclick="javascript:answer('3');">
									가입 회원 전용 초저가몰 이용권한
								</td>
							</tr>
							<tr>
								<td class="quiz_item_checkbox" onclick="javascript:answer('4');">
									<img src="/common/images/promotion/am_pc_checkbox.png" style="width:100%;"/>
									<img src="/common/images/promotion/am_pc_checkbox_on.png" style="width:100%;" class="quiz_checkbox_on"/>
								</td>
								<td class="quiz_item_txt" onclick="javascript:answer('4');">
									무조건 호박고구마를 드리는 혜택
								</td>
							</tr>
						</table>
					...
					<div class="quiz_btn">
						<img src="/common/images/promotion/am_pc_btn_checkbox.png" onClick="show_modal_info();"/>
					</div>
					<div class="quiz_hint_container">
						<div class="quiz_hint_inner">
							<img src="/common/images/promotion/am_pc_02.jpg" class="quiz_hint_img"/>
						</div>
					</div>
				</div>
			</div>
			
			<div><img src="/common/images/promotion/am_pc_03.jpg" style="width:100%;"/></div>
			<div><img src="/common/images/promotion/am_pc_04.jpg" style="width:100%;"/></div>
			<div><img src="/common/images/promotion/am_pc_05.jpg" style="width:100%;"/></div>
			<div><a href="http://member.imreadymall.com/event/goods_event.php?event_ix=617&event_type=P" target="_blank"><img src="/common/images/promotion/am_pc_06.jpg" style="width:100%;"/></a></div>
		</div>
		
		<div class="mo">
			<div><img src="/common/images/promotion/am_mo_01.jpg" style="width:100%;"/></div>
			<div class="quiz_container">
				<div class="quiz_inner">
					<div class="quiz_question">
						<table class="quiz_question_table">
					...
					<div class="quiz_item">
						<table class="quiz_item_table">
							<tr>
								<td class="quiz_item_checkbox" onclick="javascript:answer('1');">
									<img src="/common/images/promotion/am_mo_checkbox.png" style="width:100%;"/>
									<img src="/common/images/promotion/am_mo_checkbox_on.png" style="width:100%;" class="quiz_checkbox_on"/>
								</td>
								<td class="quiz_item_txt" onclick="javascript:answer('1');">
									오션월드 할인혜택
								</td>
					...
					<div class="quiz_btn">
						<img src="/common/images/promotion/am_mo_btn_checkbox.png" onClick="show_modal_info();"/>
					</div>
					<div class="quiz_hint_container">
						<div class="quiz_hint_inner">
							<img src="/common/images/promotion/am_mo_02.jpg" class="quiz_hint_img"/>
						</div>
					</div>
				</div>
			</div>
			
			<div><img src="/common/images/promotion/am_mo_03.jpg" style="width:100%;"/></div>
			<div><img src="/common/images/promotion/am_mo_04.jpg" style="width:100%;"/></div>
			<div><img src="/common/images/promotion/am_mo_05.jpg" style="width:100%;"/></div>
			<div class="pc"><a href="http://member.imreadymall.com/event/goods_event.php?event_ix=617&event_type=P" target="_blank"><img src="/common/images/promotion/am_mo_06.jpg" style="width:100%;"/></a></div>
			<div class="mo"><a href="http://m.member.imreadymall.com/event/goods_promotion.php?kind=P&event_ix=618" target="_blank"><img src="/common/images/promotion/am_mo_06.jpg" style="width:100%;"/></a></div>
		</div>
		...
		<div class="modal modal_info">
			<div class="modal_container">
				...
				<img src="/common/images/promotion/am_pop_top.png" style="width:100%;" />
		...
		<div class="modal modal_complete">
			<div class="modal_container">
				<div class="modal_contents">
					<div><img src="/common/images/promotion/am_pop_end_1.png" style="width:100%; cursor:pointer;" onClick="javascript:nextgo1();"/></div>
					<div><img src="/common/images/promotion/pop_complete.png" style="width:100%;" onClick="modal_complete_close();" /></div>
					<div class="pc"><img src="/common/images/promotion/am_pop_end_3.png" style="width:100%; cursor:pointer;" onClick="javascript:nextgo2();"/></div>
					<div class="mo"><img src="/common/images/promotion/am_pop_end_3.png" style="width:100%; cursor:pointer;" onClick="javascript:nextgo2_mo();"/></div>
				</div>
			</div>
		</div>
		...
		<div class="modal modal_hint">
			<div class="modal_container">
				...
				<div class="modal_contents">
					<img src="/common/images/promotion/am_pop_hint.png" style="width:100%;" onClick="modal_hint_close();" />
				</div>
			</div>
		</div>
		...
		<div class="modal modal_not_time">
			<div class="modal_container">
				<div class="modal_contents">
					<a href="/main/index.do"><img src="/common/images/promotion/am_pop_prev.png" style="width:100%;" /></a>
				</div>
			</div>
		</div>
		</c:if>
		...
		<div class="modal modal_not_time">
			<div class="modal_container">
				<div class="modal_contents">
					<div><img src="/common/images/promotion/am_pop_end_1.png" style="width:100%; cursor:pointer;" onClick="javascript:nextgo1();"/></div>
					<div><a href="/main/index.do"><img src="/common/images/promotion/am_pop_end_2.png" style="width:100%;"/></a></div>
					<div class="pc"><img src="/common/images/promotion/am_pop_end_3.png" style="width:100%; cursor:pointer;" onClick="javascript:nextgo2();"/></div>
					<div class="mo"><img src="/common/images/promotion/am_pop_end_3.png" style="width:100%; cursor:pointer;" onClick="javascript:nextgo2_mo();"/></div>
				</div>
			</div>
	...
	<c:otherwise>
		<a href="https://www.naver.com/" target="_blank"><img src="/common/images/promotion/am_pc_notnaver.jpg" style="width:100%;" class="pc"/></a>
		<a href="https://www.naver.com/" target="_blank"><img src="/common/images/promotion/am_mo_notnaver.jpg" style="width:100%;" class="mo" /></a>
	</c:otherwise>
 </c:choose>	
