...
<div class="location">
						...
						<script type="text/javascript">
							jQuery(document).ready(function(){
								...
								var oIcon = new nhn.api.map.Icon("//<a href="http://www.daemyunglifeway.com/common/images/icon/pin_spot2.png">www.daemyunglifeway.com/common/images/icon/pin_spot2.png</a>", oSize, oOffset);
