...
<p class="allyTxt">대명라이프웨이는 고객님께 더 많은 혜택을 돌려드리자는 생각에서 출발해, 국내 굴지의 기업들과 혁신적 제휴 모델을 선보입니다.<br>대명라이프웨이의 결합상품을 만나보세요.</p>
						...
						<div class="medalDiv mt20">
							...
							<div>
								<p><span class="red">업계 최초</span>, 라이프서비스와 생활 / 가전 서비스 결합 출시</p>
						...
						<div class="joinIntro mt20">
							<a href="/lifeway-service/etc-product/contentsid/187/index.do" class="join1">
							...
							<a href="/lifeway-service/etc-product/contentsid/188/index.do" class="join2">
							...
							<a href="/lifeway-service/etc-product/contentsid/189/index.do" class="join3">
							...
							<a href="/lifeway-service/etc-product/contentsid/190/index.do" class="join4">
