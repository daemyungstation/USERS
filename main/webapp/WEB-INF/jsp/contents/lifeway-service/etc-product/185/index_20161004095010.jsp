...
<p class="allyTxt">대명라이프웨이는 고객님께 더 많은 혜택을 돌려드리자는 생각에서 출발해, 국내 굴지의 기업들과 혁신적 제휴 모델을 선보입니다.<br>대명라이프웨이의 결합상품을 만나보세요.</p>
						...
						<div class="joinIntro mt20">
							<a class="join4" href="/lifeway-service/etc-product/contentsid/190/index.do">
							...
							<a class="join1" style="margin: 0px 0px 20px 20px;" href="/lifeway-service/etc-product/contentsid/187/index.do">
							...
							<!--2016-09-01 주석
								<a class="join5" href="/lifeway-service/etc-product/contentsid/247/index.do">
