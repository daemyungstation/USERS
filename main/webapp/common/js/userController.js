$(document).ready(function(){
	...
	CommonCtrl.PostcodeIframe = function(zipcd, adr){
    	var element_wrap = document.getElementById('daum_zipcode_wrap');
		...
		id : { 
			...
			zipcode_iframe: {
				event : {
					click : function(e){
						e.preventDefault();	
						CommonCtrl.PostcodeIframe('zipcd', 'adr');					   
					}
				}
			},
			marketingAgree : {
